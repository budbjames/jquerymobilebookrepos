...
See the difference below <<FIG2.16.2>>of replacing the collapsible containers to +<div data-role="collapsible" data-theme="a" data-content-theme="c">+
